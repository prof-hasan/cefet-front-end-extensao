...
5. [História do JavaScript](#historia-do-javascript)
6. [Estilizando elementos dinamicamente](#estilizando-elementos-dinamicamente)
7. [Eventos de mouse - além do `click`](#eventos-de-mouse)
...
- É possível **colocar ou remover classes** <!-- {.alternate-color} --> de elementos: <!-- {ul:.bulleted} -->
  ...
  ```
  - <iframe width="250" height="170" src="//jsfiddle.net/Lrhmp7ys/embedded/result/" allowfullscreen="allowfullscreen" frameborder="0" class="push-right bring-forward"></iframe>
