...
## Adaptando com biliotecas de abstração

- Considere o seguinte código: 
```html
  <ul id="lista">
    <li draggable="true">🍕 Pizza</li>
    <li draggable="true">🍔 Hambúrguer</li>
    <li draggable="true">🍣 Sushi</li>
  </ul>
```

---
## Usando a API diretamente: <!-- {ul:.bulleted} -->
  ...
  ```
---
## Com a biblioteca [Sortable](https://sortablejs.github.io/Sortable/):
  ...
  ```
- Não esqueça de Referenciar a biblioteca: 
  ```html
